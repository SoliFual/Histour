  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.sectionContainer}>
          <TouchableOpacity style={styles.sectionHeader} onPress={() => router.push('/admin-list-admins')}>
            <Text style={[styles.sectionTitle, { color: colors.text }]}>Administradores</Text>
              ...
              {administradores.map((admin, index) => (
                <View key={index} style={[styles.userRow, index === administradores.length - 1 ? { borderBottomWidth: 0 } : { borderBottomColor: colors.border }]}>
                  ...
                  <View style={styles.userInfo}>
                    ...
                    <Text style={[styles.roleText, { color: colors.primary }]}>{admin.role}</Text>
                  </View>
        ...
        {/* SECCIÓN 2: USUARIOS */}
        <View style={styles.sectionContainer}>
          {/* 👇 Flecha conectada a la lista de usuarios 👇 */}
              ...
              {usuarios.map((usuario, index) => (
                <View key={index} style={[styles.userRow, index === usuarios.length - 1 ? { borderBottomWidth: 0 } : { borderBottomColor: colors.border }]}>
                  ...
                  <View style={styles.userInfo}>
                    ...
                    <Text style={[styles.roleText, { color: colors.textSecondary }]}>{usuario.role}</Text>
                  </View>
                  <View style={styles.rightInfo}>
      ...
      <View style={styles.bottomNav}>
        ...
        {/* 👇 Botón conectado a la gestión de monumentos 👇 */}
...
const styles = StyleSheet.create({
  ...
  mainContent: { flex: 1, paddingHorizontal: 20, paddingTop: 20, paddingBottom: 10 },
