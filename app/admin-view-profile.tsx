    ...
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.backButton} onPress={() => router.back()}>
          ...
          <Text style={[styles.headerTitle, { color: colors.primary }]}>Ver Perfil</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.fieldWrapper}>
          <Text style={[styles.fieldLabel, { color: colors.primary }]}>ID de Usuario:</Text>
        ...
        <View style={styles.fieldWrapper}>
          <Text style={[styles.fieldLabel, { color: colors.primary }]}>Rol en el sistema:</Text>
...
const styles = StyleSheet.create({
  ...
  fieldLabel: { 
    ...
    fontWeight: 'bold', 
    marginRight: 10,
    width: 140, // Fija el ancho de la etiqueta para que los valores queden alineados
  },
  fieldValue: { 
    flex: 1, 
    fontSize: 15, 
